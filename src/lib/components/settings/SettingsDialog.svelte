<script lang="ts">
  ...
  import { X, Save, Bot, PenTool, RotateCcw, Sliders } from "lucide-svelte";
  ...
  const DEFAULTS = {
    llm: {
      ...
      maxTokens: 2000,
      systemPrompt:
        "You are an expert Draw.io diagram assistant. You have access to the current XML of the diagram. When asked to modify the diagram, provide the full updated XML in a code block. When asked to explain, reference specific cell IDs or values.",
    },
    drawio: {
  ...
  function resetField(
    category: "llm" | "drawio" | "preferences",
    field: string,
  ) {
    // @ts-ignore
...
{#if open}
  ...
  >
    <div
      class="bg-white w-[600px] h-[600px] overflow-hidden rounded-2xl border border-neutral-200 shadow-2xl flex flex-col transform transition-all scale-100"
    >
      <!-- Header -->
      <div
          ...
          >
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                >
                <button
                  onclick={() => resetField("llm", "systemPrompt")}
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                >
                <button
                  onclick={() => resetField("llm", "baseUrl")}
                  class="text-neutral-400 hover:text-blue-600 transition-colors"
                  title="Reset to default"
                >
                  <RotateCcw size={14} />
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between">
                  ...
                  >
                  <button
                    onclick={() => resetField("llm", "temperature")}
                    class="text-neutral-400 hover:text-blue-600 transition-colors"
                    title="Reset to default"
                  >
                    <RotateCcw size={14} />
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                >
                <button
                  onclick={() => resetField("llm", "maxTokens")}
                  class="text-neutral-400 hover:text-blue-600 transition-colors"
                  title="Reset to default"
                >
                  <RotateCcw size={14} />
        ...
        {:else if activeTab === "preferences"}
          ...
          >
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <label class="text-sm font-medium text-neutral-700 block">
                  Auto-apply Draw.io Snippets
                </label>
                <button
                  onclick={() =>
                    resetField("preferences", "autoApplyDrawioSnippets")}
                  class="text-neutral-400 hover:text-blue-600 transition-colors"
                  title="Reset to default"
                >
                  <RotateCcw size={14} />
          ...
          >
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                >
                <button
                  onclick={() => resetField("drawio", "baseUrl")}
      ...
      <!-- Footer -->
      <div
        class="p-4 border-t border-neutral-100 flex justify-end gap-3 bg-white"
      >
        <button
          onclick={() => (open = false)}
